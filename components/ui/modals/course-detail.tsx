          ...
          <Tabs defaultValue="curriculum" className="mt-6">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="prose prose-sm max-w-none dark:prose-invert">
                ...
                <p>
                  This comprehensive course will take you from the fundamentals to advanced concepts. Whether you're a
                  beginner or looking to refresh your skills, this course provides a structured learning path with
              ...
              <div className="space-y-4">
                <div className="p-4 border rounded-md">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Excellent course! The instructor explains complex concepts in a way that's easy to understand. I've
                    learned so much and feel confident applying these skills to my projects.
                  </p>
                </div>
                ...
                <div className="p-4 border rounded-md">
                  ...
                  <p className="text-sm text-muted-foreground">
                    This course exceeded my expectations. The projects were challenging but doable, and I feel like I've
                    gained valuable skills that I can immediately apply at work.
                  </p>
                </div>
              </div>
            </TabsContent>
